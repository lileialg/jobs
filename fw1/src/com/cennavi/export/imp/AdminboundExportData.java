...
public class AdminboundExportData extends ExportDataAbs implements ExportData {

	@Override
	public byte[] export(String layerName, int x, int y, int z) throws Exception {

		String sql = "select pid,kind,form,admin_id,st_astext(geom) wkt from admin_boundary a where st_intersects(a.geom,st_geometryfromtext(?,4326)) = true";
