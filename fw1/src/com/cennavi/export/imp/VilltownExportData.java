...
public class VilltownExportData extends ExportDataAbs implements ExportData {

	@Override
	public byte[] export(String layerName, int x, int y, int z) throws Exception {

		String sql = "select pid,kind_code,admin_id,name_zh,name_en,st_astext(geom) wkt from village_town a where st_intersects(a.geom,st_geometryfromtext(?,4326)) = true";
		...
		while (resultSet.next()) {
			...
			attr.put("kind_code", resultSet.getString("kind_code"));
