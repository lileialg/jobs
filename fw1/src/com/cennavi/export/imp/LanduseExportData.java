...
public class LanduseExportData extends ExportDataAbs implements ExportData {

	@Override
	public byte[] export(String layerName, int x, int y, int z) throws Exception {

		String sql = "select pid,kind,name_zh,name_en,st_astext(geom) wkt from landuse a where st_intersects(a.geom,st_geometryfromtext(?,4326)) = true";
