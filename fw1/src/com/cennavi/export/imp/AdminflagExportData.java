...
public class AdminflagExportData extends ExportDataAbs implements ExportData {

	@Override
	public byte[] export(String layerName, int x, int y, int z) throws Exception {

		String sql = "select pid,admin_id,type,capital,name_zh,name_en,st_astext(geom) wkt from admin_flag a where st_intersects(a.geom,st_geometryfromtext(?,4326)) = true";
		...
		while (resultSet.next()) {
			...
			attr.put("type", resultSet.getInt("type"));
			
			attr.put("capital", resultSet.getInt("capital"));
