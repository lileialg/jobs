...
public class WaterlineExportData extends ExportDataAbs implements ExportData {

	@Override
	public byte[] export(String layerName, int x, int y, int z) throws Exception {

		String sql = "select pid,st_astext(geom) wkt from water_line a where st_intersects(a.geom,st_geometryfromtext(?,4326)) = true";
